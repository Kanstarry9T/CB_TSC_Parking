...
class SimProc(Process):
    ...
    def run(self):
        ...
        print('The neural networks is {}'.format(neural_networks))
    ...
    def run_sim(self, neural_networks):
        ...
        # step 2: create traffic signal controller
        # self.sim.create_tsc(self.rl_stats, self.exp_replays, self.eps, neural_networks)
        
        self.sim.create_tsc(default_tsc='websters')
    ...
    def write_to_csv(self, data):
        csv_path = os.path.join(self.args.out, str(self.args.sim) + str(self.args.tsc) + '.csv')
