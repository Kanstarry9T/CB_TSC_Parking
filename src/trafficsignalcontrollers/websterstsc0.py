...
save_path = 'output/tsc_data/'

class WebstersTSC(TrafficSignalController):
    def __init__(self, conn, tsc_id, mode, netdata, red_t, yellow_t, g_min, c_min, c_max, sat_flow=0.38, update_freq=None, save_signal=False):
    ...
    def get_phase_cycle(self):
        '''
        Store list of green phases into a "cycle" data structure
        '''
        phase_cycle = []
    ...
    def websters(self):
        ...
        # print("At time {}, green phase duration is {}".format(self.t, self.green_phase_duration))
